        ...
        <p><b>สถานะใช้งาน :</b><?php echo ($row['status_seat'] == '1') ? 'อนุญาติเเล้ว' : 'รอการอนุญาติ';
                        ...
                        <br>
                            <?php if ($row['status_seat'] == '0') { ?>
                                <a class="btn-green btn-w100" href="?YES=<?php echo $row['re_id'] ?>" class="btn_submit">อนุญาติ</a>
                            <?php } else { ?>
                                <a class="btn-red btn-w100" href="?NO=<?php echo $row['re_id'] ?>" class="btn_delete">ปฏิเสธ</a>
                            <?php    } ?>
        <?php }
                 ?>
    </div>
