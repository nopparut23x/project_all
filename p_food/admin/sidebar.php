...
<body>
    <div class="sidebar">
        <ul>
            ...
            <li><a class="<?php echo $url == 'category'?"active":""; ?>" href="category.php">หมวดหมู่อาหาร</a></li>
            <li><a class="<?php echo $url == 'pay'?"active":""; ?>" href="pay.php">การชำระเงิน</a></li>
            <li><a class="<?php echo $url == 'status'?"active":""; ?>" href="status.php">การสั่งอาหาร</a></li>
