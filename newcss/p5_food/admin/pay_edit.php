...
<body>
    ...
    <form method="post" enctype='multipart/form-data'>
        ...
        <p>ชื่อบัญชี</p>
        <input type="text" name="name" required value="<?php  echo $row['pay_name'] ?>">
        <p>เลขบัญชี</p>
        <input type="text" name="bank_id" required  value="<?php  echo $row['bank_id'] ?>">
        <br>
        <br>
        <label for="bank_name">ธนาคาร</label>
        <select name="bank" id="bank_name" style="text-align:center;">
        <option selected disabled  value="<?php echo $row['bank'] ?>"><?php echo $row['bank'] ?></option>
