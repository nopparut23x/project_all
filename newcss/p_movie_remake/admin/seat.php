...
<br>  
    ...
    <a class="btn btn-w100" href="seat_edit.php?id=<?php echo $row['seat_id'] ?>&movie_id=<?php echo $_GET['id'] ?>">เเก้ไข</a>
        <br>
        <a class="btn btn-w100" href="?del=<?php echo $row['seat_id'] ?>">ลบ</a>
    </div>
        <?php } ?>
</div>  
    <br>
