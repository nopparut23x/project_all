...
<body>
    <div class="navbar">
        ...
        <ul>
            ...
            <li><a class="<?php echo $url == 'm_user'?"active":""; ?>" href="m_user.php">จัดการผู้เลือกตั้ง</a></li>
            <li><a class="<?php echo $url == 'vote'?"active":""; ?>" href="vote.php">จัดการเลือกตั้ง</a></li>
            <li><a class="<?php echo $url == 'score_vote'?"active":""; ?>" href="score_vote.php">ผลคะเเนนเลือก</a></li>
            <li style=""><a class="btn-logout" href="logout.php" onclick="return confirm('คุณต้องการออกจากระบบ?')">ออกจากระบบ</a></li>
        </ul>
    </div>
    <div class="sidebar">
